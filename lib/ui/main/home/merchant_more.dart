...
class MerchantMorePage extends StatefulWidget {
  @override
  _MerchantMorePageState createState() => _MerchantMorePageState();
}

class _MerchantMorePageState extends State<MerchantMorePage> {
